    ...
    <div className="space-y-3 w-full">
      ...
      <div className="rounded-lg border bg-accent/25 p-3">
        <div className="space-y-0.5">
          <div className="text-xs font-medium">{t("dialog.telnetAdvanced", "Telnet Advanced")}</div>
        ...
        <div className="mt-3 grid gap-2">
          ...
          <div className="grid gap-2 md:grid-cols-2">
            ...
            {renderSwitchRow(
              ...
              t("dialog.telnetSendNawsDesc", "Send terminal size changes in standard Telnet mode."),
              sendNaws,
              setSendNaws,
              rawTcpCli,
            )}
